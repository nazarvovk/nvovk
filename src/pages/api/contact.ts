...
export const ContactInputSchema = z.object({
  ...
  message: z
    .string()
    .min(10)
    .max(10000, 'Max 10,000 characters. Are you trying to send me the entire Bee Movie script?'),
})
export type ContactInput = z.infer<typeof ContactInputSchema>

type ContactContext = ContextWithValidatedRequestBody<typeof ContactInputSchema>
